...
public interface IRenderMapper {
   ...
   */
  interface IBlockRenderMapper extends IRenderMapper {
    /**
     ...
     */
    interface IRenderLayerAware extends IBlockRenderMapper {

      /**
       * Render mappers that implement this sub-interface will be called even if their block is painted.
       */
      interface IPaintAware extends IRenderLayerAware {

      }
    }
  }

  interface IItemRenderMapper extends IRenderMapper {
     ...
     */
    interface IItemStateMapper extends IItemRenderMapper {
      /**
     ...
     */
    interface IItemModelMapper extends IItemRenderMapper {
      /**
     ...
     */
    interface IDynamicOverlayMapper extends IItemRenderMapper {
      /**
